      ...
      <div className="about-container">
        ...
        <div className="col project slider-one">
          <div className="project-details-two">
            ...
            <p className="project-links"> 8 days | <a href="https://github.com/justinesolano/sei-project-three/blob/main/README.md" target="_blank" rel="noreferrer" style={{ color: 'black' }}>Read Me</a> | <a href="https://jetflixapp.herokuapp.com/" target="_blank" rel="noreferrer" style={{ color: 'black' }}>Deployed project</a> </p>
          </div>
        ...
        <div className="col project slider-one">
          <div className="project-details-two">
            ...
            <p className="project-links"> 8 days | <a href="https://github.com/justinesolano/sei-project-one/blob/main/README.md" target="_blank" rel="noreferrer" style={{ color: 'black' }}>Read Me</a> | <a href="https://justinesolano.github.io/sei-project-one/" target="_blank" rel="noreferrer" style={{ color: 'black' }}>Deployed project</a> </p>
          </div>
          <AwesomeSlider style={{ width: 600, height: 300 }} className="slider-settings">
